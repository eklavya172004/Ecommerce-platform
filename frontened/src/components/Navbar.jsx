...
const Navbar = () => {
  ...
  return (
    ...
    <div className='text-red-500 font-bold hidden md:block'>$23.23</div>
             <svg className='w-7 -mr-5 md:mr-5 hover:cursor-pointer' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="ast-basket-icon-svg" x="0px" y="0px" width="100" height="100" viewBox="826 826 140 140" enable-background="new 826 826 140 140" xml:space="preserve" fill='red'>
